...
router.post('/register', async (req: Request, res: Response) => {
  try {
    ...
    const primaryRow: SheetRow = {
      ...
      parentWillingToVolunteer: data.parentWillingToVolunteer,
      ...
      student2ParentWillingToVolunteer: data.additionalStudents?.[0]?.parentWillingToVolunteer,
      ...
      student3ParentWillingToVolunteer: data.additionalStudents?.[1]?.parentWillingToVolunteer,
      ...
      student4ParentWillingToVolunteer: data.additionalStudents?.[2]?.parentWillingToVolunteer,
      timestamp,
    };
