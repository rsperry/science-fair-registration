          ...
          {error ? (
            ...
            <>
              ...
              <Box sx={{ my: 3, display: 'flex', flexDirection: 'column', gap: 2 }}>
                ...
                <Box sx={{ px: 2, py: 1.5, border: '1px solid', borderColor: 'divider', borderRadius: 2 }}>
                ...
                <Box sx={{ px: 2, py: 1.5, border: '1px solid', borderColor: 'divider', borderRadius: 2 }}>
                  ...
                  <Typography variant="body1" sx={{ mb: 0 }}>
                    ...
                    • Messy projects must be contained to prevent spills<br />
                    • Projects must be latex-free<br />
                ...
                <Box sx={{ px: 2, py: 1.5, border: '1px solid', borderColor: 'divider', borderRadius: 2 }}>
                  ...
                  <Typography variant="body1" sx={{ mb: 0.5 }}>
                    Projects will be evaluated based on the following criteria depending on project type:
                  </Typography>
